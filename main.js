...
global.owner = ['628989031500@s.whatsapp.net'] // Put your number here
global.mods = ['628989031500@s.whatsapp.net'] // Want some help?
global.prems = ['628989031500@s.whatsapp.net'] // Premium user has unlimited limit
global.prems = ['628813964363@s.whatsapp.net'] // Premium user has unlimited limit
global.prems = ['62881026989091@s.whatsapp.net'] // Premium user has unlimited limit
global.timestamp = {
  start: new Date
}
...
global.dfail = (type, m, conn) => {
  let msg = {
    rOwner: 'Perintag ini hanya dapat digunakan oleh _*OWNER*_',

...
`.trim(), m)
  ...
  global.math[id] = [
    await conn.reply(m.chat, `Berapa hasil dari *${math.str}*?\n\nTimeout: ${(math.time / 1000).toFixed(2)} detik\nBonus Jawaban Benar: ${math.bonus} Rupiah`, m),
    math, 4,
    setTimeout(() => {
...
let modes = {
  ...
  impossible: [-99999999999, 99999999999, -99999999999, 999999999999, '*/', 30000, 999999],
  impossible2: [-999999999999999, 999999999999999, -999, 999, '/', 30000, 9999999]
} 
